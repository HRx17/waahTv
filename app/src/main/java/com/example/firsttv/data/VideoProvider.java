...
package com.example.firsttv.data;
...
public class VideoProvider {
    ...
    private static HashMap<Object, List<List>> sMovieList;
    ...
    public static HashMap<Object, List<List>> getMovieList() {
        return sMovieList;
    }

    public static HashMap<Object, List<List>> buildMedia(Context ctx, String url)
            throws JSONException {
        if (null != sMovieList) {
            return sMovieList;
        }
        sMovieList = new HashMap<Object, List<List>>();
        ...
        if (null != categories) {
            ...
            for (int i = 0; i < categories.length(); i++) {
                ...
                if (null != videos) {
                    ...
                    sMovieList.put(category_name, Collections.singletonList(categoryList));
                }
            }
        }
        return sMovieList;
