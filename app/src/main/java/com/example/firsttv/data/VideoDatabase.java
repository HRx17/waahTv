...
public class VideoDatabase {
    ...
    private static int CARD_WIDTH = 333;
    private static int CARD_HEIGHT = 230;
    ...
    private static class VideoDatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        private void loadMovies() throws IOException {
            ...
            HashMap<Object, List<List>> movies = null;
            try {
         ...
         * @param movie
         */
        public long addMovie(Live movie) {
            ContentValues initialValues = new ContentValues();
            initialValues.put(KEY_NAME, movie.getTitle());
            initialValues.put(KEY_DESCRIPTION, movie.getId());
            initialValues.put(KEY_ICON, movie.getLiveImageUrl());
